...
建议先看下 常规自动化构建的 理念和历史发展 [maven/ant/gradle使用](http://topsli.github.io/2015/07/13/maven.html)
...
3. google jib 方案，使用maven 插件，将过程内置到 maven build 过程中，并根据image registry 格式，直接push到registry 中。  jib 应用参见 [jib源码分析及应用](http://topsli.github.io/2018/11/19/jib_source.html)
